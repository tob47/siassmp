...
<table border="0" width="101%" cellpadding="0" cellspacing="0" id="content-table">
<tr>
    ...
    <div id="content-table-inner">
		...
		<div id="step-holder">
		  ...
		  <div class="step-no-off">1</div>
			<div class="step-light-left"><a href="../nilai_siswa/?page=input_nilai">Pilih Mata Pelajaran</a></div>
		...
		$kelas=mysql_fetch_array(mysql_query("select * from tbl_jadwal where kelas='$kelass'"));
      ...
      <br />
        ...
        <form id="mainform" action="../nilai_siswa/home.php?page=input_nilai_siswa" method="post">
        <table border="0" width="104%" cellpadding="0" cellspacing="0" id="product-table">
         <tr bgcolor="#99CC33">
            <td width="4%">Nomor	</td>
